...
>$\{\cos\alpha,\cos\beta\}为在点(x,y)的单位切向量$
...
>$\{\cos\alpha,\cos\beta\,\cos\gamma\}为在点(x,y,z)$
...
=$\iint\limits_{\Sigma}\left|\begin{array}{ccc}\cos \alpha&\cos\beta&\cos\gamma\\\frac{\partial}{\partial x}&\frac{\partial}{\partial y}&\frac{\partial}{\partial z}\\P&Q&R\end{array}\right|dS$(第一型曲面积分)
